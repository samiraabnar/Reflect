...
import pytorch_models.layers as layers
import pytorch_models.opts as opts
from pytorch_models.dataset import Dataset
import time
import math
...
# dictionaries
parser.add_argument('-dict', required=True, default='vocab',
