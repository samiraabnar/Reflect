...
--student_exp_name=gc_o_std3005 \
--teacher_exp_name=gc_o_tchr3005 \
...
--student_exp_name=gc_o_std3015 \
--teacher_exp_name=gc_o_tchr3015 \
--teacher_config=small_lstm_v4 \
--student_config=small_gpt_v9 \
--distill_mode=online \
--distill_config=pure_dstl_4_crs_slw_hld3 > run0 &
...
--student_model=cl_gpt2_shared \
--student_exp_name=gc_fo_std3025 \
--teacher_exp_name=gc_o_tchr3025 \
...
--teacher_model=cl_bert \
--student_model=cl_gpt2 \
--student_exp_name=gc_o_std3035 \
--teacher_exp_name=gc_o_tchr3035 \
--teacher_config=small_gpt_v9 \
--student_config=small_gpt_v9 \
--distill_mode=online \
--distill_config=pure_dstl_4_crs_slw_hld3 > run0 &
...
--student_model=cl_gpt2_shared \
--student_exp_name=gc_o_std3045 \
--teacher_exp_name=gc_o_tchr3045 \
--teacher_config=small_gpt_v9 \
--student_config=small_gpt_v9 \
--distill_mode=online \
--distill_config=pure_dstl_4_crs_slw_hld3 > run0 &
...
--teacher_model=cl_gpt2_shared \
--student_model=cl_gpt2 \
--student_exp_name=gc_o_std3055 \
--teacher_exp_name=gc_o_tchr3055 \
--teacher_config=small_gpt_v9 \
--student_config=small_gpt_v9 \
--distill_mode=online \
--distill_config=pure_dstl_4_crs_slw_hld3 > run0 &
...
--student_model=cl_gpt2_shared \
--student_exp_name=gc_o_std3065 \
--teacher_exp_name=gc_o_tchr3065 \
--teacher_config=small_gpt_v9 \
--student_config=small_gpt_v9 \
--distill_mode=online \
--distill_config=pure_dstl_4_crs_slw_hld3 > run0 &
...
--teacher_model=cl_gpt2 \
--student_model=cl_gpt2 \
--student_exp_name=gc_o_std3075 \
--teacher_exp_name=gc_o_tchr3075 \
--teacher_config=small_gpt_v9 \
--student_config=small_gpt_v9 \
--distill_mode=online \
--distill_config=pure_dstl_4_crs_slw_hld3 > run0 &
