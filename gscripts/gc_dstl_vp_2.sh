...
#--teacher_model=cl_gpt2_shared \
#--student_model=cl_lstm \
#--student_exp_name=gc_o_std9100 \
#--teacher_exp_name=gc_o_tchr9100 \
#--teacher_config=small_gpt_v9 \
#--student_config=small_lstm_v4 \
#--distill_mode=online \
...
#--student_exp_name=gc_o_std8110 \
#--teacher_exp_name=gc_o_tchr8110 \
#--teacher_config=small_gpt_v9 \
...
#--teacher_model=cl_gpt2_shared \
#--student_model=cl_bert \
#--student_exp_name=gc_o_std9110 \
#--teacher_exp_name=gc_o_tchr9110 \
#--teacher_config=small_gpt_v9 \
#--student_config=small_gpt_v9 \
#--distill_mode=online \
#--distill_config=pure_dstl_4_crs_slw_vp9 > run0 &
...
--teacher_model=cl_gpt2_shared \
--student_model=cl_bert \
--student_exp_name=gc_o_std9111 \
--teacher_exp_name=gc_o_tchr9111 \
--teacher_config=small_gpt_v9 \
--student_config=small_gpt_v9 \
--distill_mode=online \
...
--teacher_model=cl_gpt2_shared \
--student_model=cl_bert \
--student_exp_name=gc_o_std9112 \
--teacher_exp_name=gc_o_tchr9112 \
--teacher_config=small_gpt_v9 \
--student_config=small_gpt_v9 \
--distill_mode=online \
--distill_config=pure_dstl_4_exp_slw_vp9 > run0 &
