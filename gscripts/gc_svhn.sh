...
--distill_mode=online \
--distill_config=pure_dstl5_4_crs_fst > o_run0 &
...
--student_config=rsnt_svhn1 \
--distill_mode=online \
--distill_config=pure_dstl_1 > o_run0 &
...
--student_config=rsnt_svhn1 \
--distill_mode=online \
--distill_config=pure_dstl_2 > o_run0 &
...
--student_config=rsnt_svhn1 \
--distill_mode=online \
--distill_config=pure_dstl_4_radamfst > o_run0 &
