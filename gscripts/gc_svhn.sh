...
--distill_mode=offline \
--batch_size=128 \
--distill_config=pure_dstl5_4_crs_slw_2 > o_run4 &
...
--distill_mode=offline \
--batch_size=128 \
--distill_config=pure_dstl5_4_crs_fst > o_run5 &
...
--distill_mode=offline \
--batch_size=128 \
--distill_config=pure_dstl5_4_crs_fst_2 > o_run6 &
...
--distill_mode=offline \
--batch_size=128 \
--distill_config=pure_dstl5_4_crs_slw > o_run7 &
...
--distill_mode=offline \
--batch_size=128 \
--distill_config=pure_dstl5_4_crs_slw_2 > o_run8 &
wait