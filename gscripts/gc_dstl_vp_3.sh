...
--teacher_model=cl_bert \
--student_model=cl_lstm \
--student_exp_name=gc_o_std3300 \
--teacher_exp_name=gc_o_tchr3300 \
--teacher_config=small_gpt_v9 \
--student_config=small_lstm_v4 \
--distill_mode=online \
--distill_config=pure_dstl_4_crs_slw_vp3 > run0 &

CUDA_VISIBLE_DEVICES=3 python distill/distill_main.py  \
--task=word_sv_agreement_vp \
--teacher_model=cl_bert \
--student_model=cl_lstm \
--student_exp_name=gc_o_std4300 \
--teacher_exp_name=gc_o_tchr4300 \
--teacher_config=small_gpt_v9 \
--student_config=small_lstm_v4 \
--distill_mode=online \
--distill_config=pure_dstl_4_crs_slw_vp4 > run0 &
...
--teacher_model=cl_bert \
--student_model=cl_bert \
--student_exp_name=gc_o_std2310 \
--teacher_exp_name=gc_o_tchr2310 \
--teacher_config=small_gpt_v9 \
--student_config=small_gpt_v9 \
--distill_mode=online \
--distill_config=pure_dstl_4_crs_slw_vp2 > run0 &
...
--teacher_model=cl_bert \
--student_model=cl_bert \
--student_exp_name=gc_o_std3310 \
--teacher_exp_name=gc_o_tchr3310 \
--teacher_config=small_gpt_v9 \
--student_config=small_gpt_v9 \
--distill_mode=online \
--distill_config=pure_dstl_4_crs_slw_vp3 > run0 &
...
--teacher_model=cl_bert \
--student_model=cl_bert \
--student_exp_name=gc_o_std4310 \
--teacher_exp_name=gc_o_tchr4310 \
--teacher_config=small_gpt_v9 \
--student_config=small_gpt_v9 \
--distill_mode=online \
--distill_config=pure_dstl_4_crs_slw_vp4 > run0 &
