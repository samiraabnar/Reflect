...
--teacher_model=cl_vff \
--student_model=cl_vff \
--student_exp_name=gc_o_std301 \
--teacher_exp_name=gc_o_tchr301 \
--teacher_config=ff_mnist4 \
--student_config=ff_mnist4 \
--distill_mode=onofflineline \
--batch_size=128 \
--keep_some_checkpoints=True \
--max_checkpoints=15 \
--distill_config=pure_dstl5_4_crs_slw_3 > o_run1 &
...
--teacher_model=cl_vff \
--student_model=cl_vff \
--student_exp_name=gc_o_std302 \
--teacher_exp_name=gc_o_tchr302 \
--teacher_config=ff_mnist4 \
--student_config=ff_mnist4 \
--distill_mode=offline \
--batch_size=128 \
...
--teacher_model=cl_vff \
--student_model=cl_vff \
--student_exp_name=gc_o_std303 \
--teacher_exp_name=gc_o_tchr303 \
--teacher_config=ff_mnist4 \
--student_config=ff_mnist4 \
--distill_mode=offline \
--batch_size=128 \
