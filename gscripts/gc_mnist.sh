...
#--teacher_model=cl_vcnn \
#--student_model=cl_vff \
#--student_exp_name=gc_f_std23 \
#--teacher_exp_name=gc_o_dtchr13 \
#--teacher_config=vcnn_mnist7 \
#--student_config=ff_mnist4 \
#--distill_mode=offline \
#--batch_size=128 \
...
#--student_config=ff_mnist4 \
#--distill_mode=online \
#--keep_some_checkpoints=True \rm -r
#--max_checkpoints=15 \
#--batch_size=128 \
