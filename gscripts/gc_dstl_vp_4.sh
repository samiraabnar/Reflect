...
--teacher_model=cl_gpt2 \
--student_model=cl_lstm \
--student_exp_name=gc_o_std3200 \
--teacher_exp_name=gc_o_tchr3200 \
--teacher_config=small_gpt_v9 \
--student_config=small_lstm_v4 \
--distill_mode=online \
...
--teacher_model=cl_gpt2 \
--student_model=cl_lstm \
--student_exp_name=gc_o_std4200 \
--teacher_exp_name=gc_o_tchr4200 \
--teacher_config=small_gpt_v9 \
--student_config=small_lstm_v4 \
--distill_mode=online \
...
--teacher_model=cl_gpt2 \
--student_model=cl_bert \
--student_exp_name=gc_o_std3210 \
--teacher_exp_name=gc_o_tchr3210 \
--teacher_config=small_gpt_v9 \
--student_config=small_gpt_v9 \
--distill_mode=online \
--distill_config=pure_dstl_4_crs_slw_vp3 > run0 &
...
--teacher_model=cl_gpt2 \
--student_model=cl_bert \
--student_exp_name=gc_o_std4210 \
--teacher_exp_name=gc_o_tchr4210 \
--teacher_config=small_gpt_v9 \
--student_config=small_gpt_v9 \
--distill_mode=online \
--distill_config=pure_dstl_4_crs_slw_vp4 > run0 &
