...
#--student_model=cl_bert \
#--student_exp_name=gc_fo_std3020 \
...
#--student_model=cl_bert \
#--student_exp_name=gc_o_std3040 \
#--teacher_exp_name=gc_o_tchr3040 \
#--teacher_config=small_gpt_v9 \
#--student_config=small_gpt_v9 \
#--distill_mode=online \
#--distill_config=pure_dstl_4_crs_slw_hld3 > run0 &
...
#--teacher_model=cl_gpt2_shared \
#--student_model=cl_lstm \
#--student_exp_name=gc_o_std3050 \
#--teacher_exp_name=gc_o_tchr3050 \
#--teacher_config=small_gpt_v9 \
#--student_config=small_lstm_v4 \
#--distill_mode=online \
#--distill_config=pure_dstl_4_crs_slw_hld3 > run0 &
...
#--student_model=cl_bert \
#--student_exp_name=gc_o_std3060 \
#--teacher_exp_name=gc_o_tchr3060 \
#--teacher_config=small_gpt_v9 \
#--student_config=small_gpt_v9 \
#--distill_mode=online \
#--distill_config=pure_dstl_4_crs_slw_hld3 > run0 &
...
#--teacher_model=cl_gpt2 \
#--student_model=cl_lstm \
#--student_exp_name=gc_o_std3070 \
#--teacher_exp_name=gc_o_tchr3070 \
#--teacher_config=small_gpt_v9 \
#--student_config=small_lstm_v4 \
#--distill_mode=online \
#--distill_config=pure_dstl_4_crs_slw_hld3 > run0 &
