...
--teacher_exp_name=gc_or_dtchr73 \
--student_exp_name=gc_std73 \
...
--teacher_exp_name=gc_or_dtchr70 \
--student_exp_name=gc_std70 \
--teacher_config=biglstm_drop31_v2 \
...
--teacher_model=lm_lstm_shared_emb \
--student_model=lm_gpt2_shared \
--teacher_exp_name=gc_or_dtchr71 \
--student_exp_name=gc_std71 \
...
--teacher_model=lm_lstm_shared_emb \
--student_model=lm_gpt2_shared \
--teacher_exp_name=gc_or_dtchr72 \
--student_exp_name=gc_std72 \
...
--teacher_model=lm_lstm_shared_emb \
--student_model=lm_gpt2 \
--teacher_exp_name=gc_or_dtchr54 \
...
--teacher_model=lm_lstm_shared_emb \
--student_model=lm_gpt2 \
--teacher_exp_name=gc_or_dtchr55 \
...
--teacher_model=lm_lstm_shared_emb \
--student_model=lm_gpt2 \
--teacher_exp_name=gc_or_dtchr56 \
...
--teacher_model=lm_lstm_shared_emb \
--student_model=lm_gpt2 \
--teacher_exp_name=gc_or_dtchr57 \
--student_exp_name=gc_std57 \
--teacher_config=lstm_drop31_v2 \
--student_config=big_gpt_v5 \
--batch_size=64 \
--distill_mode=rep_online \
