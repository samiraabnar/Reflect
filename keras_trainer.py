...
class SummaryCallback(tf.keras.callbacks.Callback):
  ...
  def on_train_batch_end(self, batch, logs=None):
    if (self.model.optimizer.iterations % 200) == 0:
      ...
      log_summary(log_name='fine_loss', log_value=logs['loss'], summary_scope='train')
...
if __name__ == '__main__':
  ...
  tf.compat.v2.summary.experimental.set_step(optimizer.iterations)
  ...
  with summary_writer.as_default():
    print("initial learning rate:", model.optimizer.learning_rate( model.optimizer.iterations))
